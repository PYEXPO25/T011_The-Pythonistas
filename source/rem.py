...
<style>
    ...
    .delete-btn { background-color: red; margin-left: 10px; }
    h2 { color: #333; }
</style>
"""
...
<table border="1" cellpadding="10">
    <tr><th>Medicine</th><th>Dosage</th><th>Time</th><th>Phone</th><th>Actions</th></tr>
    {% for med in medicines %}
        <tr>
            ...
            <td>{{ med.phone }}</td>
            <td>
                <form action="{{ url_for('delete_medicine', med_id=med.id) }}" method="post" style="display:inline;">
